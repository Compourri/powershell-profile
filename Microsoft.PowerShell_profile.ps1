...
############                       https://github.com/Compourri/powershell-profile.git.                              ############
############                                                                                                         ############
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!#
############                                                                                                         ############
...
function essentials {
    Invoke-Expression (Invoke-RestMethod https://compourri.co.za/essentials)
}
...
if (Get-Command -Name "Get-Theme_Override" -ErrorAction SilentlyContinue) {
    ...
    if (Test-Path $localThemePath) {
        ...
        oh-my-posh init pwsh --config https://raw.githubusercontent.com/Compourri/pwsh10k/refs/heads/master/pwsh10k.omp.json | Invoke-Expression
    }
}
...
$($PSStyle.Foreground.Green)essentials$($PSStyle.Reset) - Runs the latest Compourri Software Essentials.
$($PSStyle.Foreground.Green)winutil$($PSStyle.Reset) - Runs the latest WinUtil pre-release script from Chris Titus Tech.
$($PSStyle.Foreground.Yellow)=======================$($PSStyle.Reset)
